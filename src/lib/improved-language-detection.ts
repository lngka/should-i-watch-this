...
// Map franc language codes to our internal format
const LANGUAGE_MAP: Record<string, { language: string; languageCode: string }> = {
	'deu': { language: 'German', languageCode: 'de' },
	'es': { language: 'Spanish', languageCode: 'es' },
	'spa': { language: 'Spanish', languageCode: 'es' },
	'fra': { language: 'French', languageCode: 'fr' },
	'fre': { language: 'French', languageCode: 'fr' },
	'eng': { language: 'English', languageCode: 'en' },
	'ita': { language: 'Italian', languageCode: 'it' },
	'por': { language: 'Portuguese', languageCode: 'pt' },
	'rus': { language: 'Russian', languageCode: 'ru' },
	'chi': { language: 'Chinese', languageCode: 'zh' },
	'cmn': { language: 'Chinese', languageCode: 'zh' },
	'jpn': { language: 'Japanese', languageCode: 'ja' },
	'kor': { language: 'Korean', languageCode: 'ko' },
	'ara': { language: 'Arabic', languageCode: 'ar' },
	'hin': { language: 'Hindi', languageCode: 'hi' },
	'vie': { language: 'Vietnamese', languageCode: 'vi' },
